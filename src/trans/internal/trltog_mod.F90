...
IF (LHOOK) CALL DR_HOOK('TRLTOG_PROLOG',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRLTOG_PROLOG',1,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRLTOG_COMM',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRLTOG_COMM',1,ZHOOK_HANDLE)
