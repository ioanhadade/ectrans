...
!              --------------------
IF (LHOOK) CALL DR_HOOK('TRGTOL_PROLOG',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRGTOL_PROLOG',1,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRGTOL_COMM',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('TRGTOL_COMM',1,ZHOOK_HANDLE)
